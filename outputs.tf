locals {
  binding = try(google_cloudfunctions_function_iam_binding.binding[0], null)
  member  = try(google_cloudfunctions_function_iam_member.member, null)
  policy  = try(google_cloudfunctions_function_iam_policy.policy[0], null)
