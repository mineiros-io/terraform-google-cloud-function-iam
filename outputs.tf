locals {
  binding = one(google_cloudfunctions_function_iam_binding.binding)
  member  = google_cloudfunctions_function_iam_member.member
  policy  = one(google_cloudfunctions_function_iam_policy.policy)
